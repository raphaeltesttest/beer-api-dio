<h2>Digital Innovation: Expert class - Desenvolvimento de testes unitários para validar uma API REST de gerenciamento de estoques de cerveja utilizando Java 16 .</h2>
...
* Java 14 ou versões superiores. Neste projeto foi utilizado o Java 16.
* Maven 3.6.3 ou versões superiores.
* MapStruct 1.4.x
* Spring Boot versão 2.5.3
